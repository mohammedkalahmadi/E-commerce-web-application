import svgPaths from "./svg-dw2uk83mkt";
...
function ProductCard() {
  return (
    <div className="absolute h-[199px] left-[5px] top-[515px] w-[392px]" data-name="Product card">
      ...
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal inset-[9.05%_10.36%_79.4%_34.09%] leading-[normal] not-italic text-[14px] text-black whitespace-pre-wrap">Amber Executive Derby</p>
      <p className="absolute font-['Cairo:Regular',sans-serif] font-normal inset-[20.6%_40.42%_68.84%_34.09%] leading-[normal] not-italic text-[14px] text-black whitespace-pre-wrap">699SR</p>
      ...
      <div className="absolute left-[307px] size-[29px] top-[118px]" data-name="Number 2">
        <div className="absolute inset-[16.67%_33.33%_20.83%_33.33%]" data-name="Vector">
          <div className="absolute inset-[-6.67%_-12.5%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.0833 20.5417">
              <path d={svgPaths.p3400fc0} id="Vector" stroke="var(--stroke-0, black)" strokeLinecap="square" strokeWidth="2.41667" />
            </svg>
          </div>
        </div>
      </div>
...
export default function ShoppingCart() {
  return (
    <div className="bg-white relative size-full" data-name="Shopping cart 4">
      ...
      <ProductCard />
      <p className="absolute font-['Cairo:Bold',sans-serif] font-bold h-[27px] leading-[normal] left-[8px] not-italic text-[24px] text-black top-[714px] w-[125px] whitespace-pre-wrap">{` Price `}</p>
      <p className="absolute font-['Cairo:Bold',sans-serif] font-bold h-[37px] leading-[normal] left-[calc(66.67%+31px)] not-italic text-[24px] text-black top-[714px] w-[115px] whitespace-pre-wrap">1547SR</p>
