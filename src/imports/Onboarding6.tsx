import svgPaths from "./svg-kkgq6q9za6";
...
export default function Onboarding() {
  return (
    <div className="bg-white relative size-full" data-name="Onboarding 6">
      ...
      <p className="absolute font-['Cairo:Medium',sans-serif] font-medium h-[30px] leading-[normal] left-[349px] not-italic text-[16px] text-black top-[21px] w-[37px] whitespace-pre-wrap">Done</p>
