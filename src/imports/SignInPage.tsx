import svgPaths from "./svg-n19al1amqu";
...
export default function SignInPage() {
  return (
    <div className="bg-white relative size-full" data-name="Sign in page">
      ...
      <div className="absolute left-[calc(33.33%+44px)] size-[45px] top-[695px]" data-name="Facebook">
      ...
      <div className="absolute inset-[79.52%_63.68%_15.33%_25.12%] overflow-clip" data-name="Google">
      ...
      <div className="absolute h-[45px] left-[44px] top-[439px] w-[312px]" data-name="Button">
      ...
      <div className="-translate-y-1/2 absolute flex flex-col font-['Cairo:Medium',sans-serif] font-medium h-[32px] justify-center leading-[0] left-[calc(50%+49px)] not-italic text-[#e60000] text-[16px] top-[583px] w-[132px]">
      ...
      <div className="absolute left-[calc(50%+57px)] overflow-clip size-[45px] top-[695px]" data-name="apple">
        <div className="absolute inset-[6.25%]" data-name="bg">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 39.375 39.375">
      ...
      <div className="-translate-y-1/2 absolute flex flex-col font-['Cairo:Medium',sans-serif] font-medium h-[42px] justify-center leading-[0] left-[calc(16.67%+11px)] not-italic text-[0px] text-black top-[793px] w-[259px]">
