import svgPaths from "./svg-285u65cumv";
...
export default function PaymentPage() {
  return (
    <div className="bg-white relative size-full" data-name="Payment page">
      ...
      <div className="absolute flex h-px items-center justify-center left-0 top-[745px] w-[402px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19.078125" } as React.CSSProperties}>
      ...
      <div className="absolute flex h-px items-center justify-center left-0 top-[502px] w-[402px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19.078125" } as React.CSSProperties}>
        <div className="flex-none rotate-[-0.14deg]">
          <div className="h-0 relative w-[402.001px]">
            <div className="absolute inset-[-1px_0_0_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 402.001 1">
      ...
      <div className="absolute flex items-center justify-center left-[calc(83.33%+29px)] size-[29px] top-[153px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19.078125" } as React.CSSProperties}>
      ...
      <div className="absolute flex h-px items-center justify-center left-0 top-[140px] w-[402px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19.078125" } as React.CSSProperties}>
        <div className="flex-none rotate-[0.14deg]">
          <div className="h-0 relative w-[402.001px]">
            <div className="absolute inset-[-1px_0_0_0]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 402.001 1">
